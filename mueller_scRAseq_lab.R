...
#     Min.features sets the minimum number of a specified feature
#     needed to include the data point in analysis. In this case, 
#     min.features = 100 means that a minimum of 100 detected genes
#     is needed to include a cell in analysis.

# Question: Report nCount_RNA and nFeature_RNA for AAACATACATTTCC-1 (2nd item) 
# from the ctrl_raw_feature_bc_matrix
